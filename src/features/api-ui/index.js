...
export const apiUI = Object.freeze(Object.fromEntries(
    Object.entries({ ...profiles, ...prompts, testConnection, fetchModels, getAssistant, setAssistant, resolveAssistant, getRequestSettings, setRequestSettings }).map(([name, operation]) => [name, async (...args) => {
        try {
